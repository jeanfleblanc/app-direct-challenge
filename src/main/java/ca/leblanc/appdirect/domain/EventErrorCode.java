...
/**
 * When the Application Vendor communicates a failure 
 * while processing information from AppDirect, one of 
 * the following error codes must be returned.
 * 
...
public interface EventErrorCode {
	 ...
	 */
	String MAX_USERS_REACHED = "MAX_USERS_REACHED";
	 ...
	 */
	String OPERATION_CANCELED = "OPERATION_CANCELED"; 
